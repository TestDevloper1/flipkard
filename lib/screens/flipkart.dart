...
class home1 extends StatefulWidget {
  ...
  @override
  State<home1> createState() => FlipkartState();
}
class FlipkartState extends State<home1> {
  @override
          ...
          child: ListView(
            ...
            children:  [
              DrawerHeader(
                ...
                DecorationImage(image: AssetImage('assets/flipkart-plus_8d85f4.png'))),
                padding: EdgeInsets.zero,
                child: UserAccountsDrawerHeader(
                  margin: EdgeInsets.zero,
                  accountName: const Text("IOT Agro Farm"),
                  accountEmail: const Text("mislam171160@bscse.uiu.ac.bd"),
                  ...
                  otherAccountsPicturesSize: Size(100, 90),
